...
const multarStorage = multer.diskStorage({
    destination: (req, file, cb) => {
        cb(null, './public/Images/ReportedAnimals'); // ✅ Fixed typo here
    },
...
exports.addReportAnimal = catchAsync(async (req, res, next) => {
    ...
    var geo = geoip.lookup('27.54.172.64'); // Optional: Replace with actual ip for dynamic location
...
exports.deleteAnimalReport = catchAsync(async (req, res, next) => {
    await animalReport.findByIdAndDelete(req.params.id); // ✅ Corrected variable name
